...
<body>
    <?php
		...
		?>
	<!--background-->
    <h1><a href ="homepage.php?value=0"> </a> Doctor Login Portal</h1>
	<div class="register-form-w3layouts">
		<!-- Form starts here -->
		<form action="doctorchk.php" method="post">
			<h3 class="sub-heading-agileits">PLEASE LOGIN HERE </h3>
			<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="docId" placeholder="Enter Your Doctor ID" required="">
    ...
    font-family: 'Source Sans Pro', sans-serif;" type="password" name="docPass" placeholder="Enter Password" required="">
				<?php 
                $val=$_GET['value'];
	           if($val==1){
	           ?>
