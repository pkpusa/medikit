...
<div class="services" id="services">
	<div class="container">
		...
		<div class="w3-services-grids">
			...
			<a href="index.php?value=0"><i class="fa fa-user-md" aria-hidden="true"></i></a>
				<h3>User</h3>
            ...
            <div class="col-md-4 w3-services-grids1">
			<div class="w3-services-grid1">
			<a href="doctorpage.php?value=0"><i class="fa fa-user-md" aria-hidden="true"></i></a>
				<h3>Doctor</h3>
				<div class="w3-services-grid1-left">
					<h4></h4>
					<p></p>
            ...
            <div class="col-md-4 w3-services-grids1">
			<div class="w3-services-grid1">
			<a href="adminlogin.php?value=0"><i class="fa fa-user-md" aria-hidden="true"></i></a>
				<h3>Admin</h3>
				<div class="w3-services-grid1-left">
					<h4></h4>
					<p></p>
